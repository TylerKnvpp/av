...
//                        .repeatCount(3, autoreverses: false)
            ...
            BackCardView()
             ...
             .background(show ? Color("card4"):  Color("card4"))
            .cornerRadius(20)
            .shadow(radius: 20)
            ...
            .rotationEffect(.degrees(show ? 0 : 10))
                ...
                .rotation3DEffect(Angle(degrees: showCard ? 0 : 10.0), axis: (x: 10.0, y: 0.0, z: 0.0))
            .blendMode(.hardLight)
            .animation(.spring())
        ...
        VStack(spacing: 20) {
            ...
            HStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 8.0) {
                    Text("Glute day").fontWeight(.bold)
                    
                    Text("12/12 exercises completed\n10 hours spent so far")
                        .font(.footnote)
